...
list_ads = [
    ...
    ' 🍓 Ягодный бум! 3, 4, 5 июня! Ждем вас на наших мероприятиях и активах!',
    '🍒 Сегодня в 16:00 на площади перед Замком состоится Ягодный бум! Smoker-Grill, анимационные игры, Яркие угощения и '
    'напитки из сезонных ягод, выступление приглашенных артистов и ярмарка! 🫐 Завтра, 5 июня на пляже отеля Довиль состоится'
    ' Пляжный мега-денс! Праздник красок Холи и марафон анимационных игр! Следите за нашим расписанием!',
]
